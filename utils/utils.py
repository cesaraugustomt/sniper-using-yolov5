...
def plot_dots_on_people(x, img):
    ...
    thickness = -1;
    color = [238, 130, 238] # tolet
    center = ((int(x[2])+int(x[0]))//2,(int(x[3])+int(x[1]))//2)
    radius = 10
    cv2.circle(img, center, radius, color, thickness)

def distancing(people_coords, img, high, dist_thres_lim=(200,250)):
