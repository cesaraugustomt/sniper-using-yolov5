...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            distancing(people_coords, im0, high, dist_thres_lim=(200,250))
            high_label =  "High : {:2d}".format(int(high))
            cv2.putText(im0, high_label, (1000,125), cv2.FONT_HERSHEY_SIMPLEX, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
            high = 0
